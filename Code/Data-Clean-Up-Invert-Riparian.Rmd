...
```
Figure 3: A bar graph of average canopy cover (y-axis) grouped by site (x-axis) and year (bar color). Higher bars represent large amounts of average canopy cover such that the Alaska site (OKSR) had very little to no tree cover. Not all sites had a 2017 or a 2021 recording, but all three sites had similar average percent canopy cover across all three years. 